...
@Composable
fun TopDetailScreen(imageData: ImageDto, detailData: DetailDto, movie: Result?, castData : CastDto) {
    var selectedIndex: Int by remember {
        mutableIntStateOf(0)
    }
    val tabList = listOf<String>("About","Cast" , "Similar" , "Recommendation")
            ...
            Scaffold(
                ...
                Box(
                    ...
                    HorizontalPager(state = tabPagerState , beyondBoundsPageCount = 2) {index->
                        when (index) {
                            0 -> {
                                TopDetailTab(detailData = detailData , movie = movie , castData = castData)
                            }
                            1 -> {
...
@Composable
fun TopDetailTab(detailData: DetailDto, movie: Result?, castData: CastDto) {
    val castMap: MutableMap<String, String> = mutableMapOf()
    var pCompanies : String =""
